...
<div class="bgimg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto ">
      <li class="nav-item active">
        <a class="nav-link text-dark" href="IndexHome.jsp">Explore<span class="sr-only">(current)</span></a>
      </li>
  ...
  <button class="btn btn-dark text-white btn-lg">START EXPLORING ANIMALS</button>
  </div >
  </div>
  ...
  <div class="row rowsetting">
          <div class="col-lg-4 col-md-4 col-sm-4 col-10 d-block m-auto">
           <div class="imgsetting d-block m-auto bg-success"> <i class="fa fa-user-circle-o fa-3x" aria-hidden="true"></i>
           </div>
           <h2>Easy Search</h2>
